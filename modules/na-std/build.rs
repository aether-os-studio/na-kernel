...
fn main() {
    ...
    let aliases = [
        ...
        "UsbDevice = na_usb_device",
        "UsbInterface = na_usb_interface",
        "UsbPipe = na_usb_pipe",
        "UsbDeviceId = na_usb_device_id",
        "UsbDeviceInfo = na_usb_device_info",
        "UsbInterfaceInfo = na_usb_interface_info",
        "UsbDriverOps = na_usb_driver_ops",
        "NetRegistration = na_net_registration",
        "NetDeviceConfig = na_net_device_config",
        "NetDeviceOps = na_net_device_ops",
